...
$config['db']['master']['username'] = 'qq_rewlkj_com';
$config['db']['master']['password'] = 'J4cbxEHyEZJp7pxc';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'qq_rewlkj_com';
...
$config['setting']['authkey'] = 'ec22defd';
